...
interface CreateNewGramageModalProps {
  open: boolean;
  onClose: () => void;
  onSuccess: () => void; 
}

const CreateGramage: React.FC<CreateNewGramageModalProps> = ({
  open,
  onClose,
  onSuccess,
}) => {
 const token = localStorage.getItem("token");
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const response = await axios.post(`${BASE_URL}/api/gramage`, payload, {
