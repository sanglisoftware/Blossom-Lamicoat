...
const EditShopModal: React.FC<EditShopModalProps> = ({ open, onClose, onSuccess, shopID }) => {
            ...
            if (open && shopID) {
                try {
                    const response = await axios.get(
                        `${BASE_URL}/api/inventory/shops/${shopID}`,
                        {
                            headers: {
        ...
        try {
            ...
            if (response.status === 200 || response.status === 201) {
                ...
                setSuccessModalConfig({
                    title: "Shop Update Successfully",
                    subtitle: "The Shop has been updated from the system.",
                    icon: "CheckCircle",
                    buttonText: "Ok",
                    onButtonClick: () => {
